  ...
  return (
    ...
    >
      ...
      <div className="flex-1 flex items-center">
        <div className="grid w-full grid-cols-1 md:grid-cols-12 gap-10 md:gap-6 items-center">
          ...
          <motion.div
            ...
            className="md:col-span-4 order-3 md:order-3 text-left md:text-right"
          >
            <h1
